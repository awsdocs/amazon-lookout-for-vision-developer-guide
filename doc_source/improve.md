...
### Image classification model metrics<a name="evaluation-model-classification-metrics"></a>

Amazon Lookout for Vision provides the following summary performance metrics for an image classification model:
...
Amazon Lookout for Vision provides the following summary performance metrics for the model:
+ [Precision](#precision-metric)
+ [Recall](#recall-metric)
+ [F1 score](#f1-metric)

Amazon Lookout for Vision provides the following summary performance metrics for each anomaly type:
+ [F1 score](#f1-metric)
...
### Testing results<a name="w160aac22b9c23"></a>
