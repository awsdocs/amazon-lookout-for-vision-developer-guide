...
**Note**  
If you've just completed [Creating your dataset](model-create-dataset.md) or [Updating your dataset](edit-dataset.md)\. The console should currently show your model dashboard and you don't need to do steps 1 \- 4\.
